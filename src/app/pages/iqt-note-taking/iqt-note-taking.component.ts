...
@Component({
  selector: 'app-iqt-note-taking',
  templateUrl: './iqt-note-taking.component.html',
  styleUrls: ['./iqt-note-taking.component.scss']
})
export class IQTNotetakingComponent implements OnInit {
  photos: Array<any> = []
  constructor() { 
