...
@Component({
  selector: 'app-health-stronger',
  templateUrl: './health-stronger.component.html',
  styleUrls: ['./health-stronger.component.scss']
})
export class HealthStrongerComponent implements OnInit {
  photos: Array<any> = []
  constructor() { 
